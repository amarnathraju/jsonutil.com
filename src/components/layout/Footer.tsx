    ...
    <footer className="bg-slate-900 text-slate-300 py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-slate-400">
              The complete JSON utility toolkit for developers. Validate, format, convert, and analyze JSON data with ease.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/diff" className="hover:text-blue-400 transition-colors">JSON Diff</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-semibold text-white mb-3">Advanced</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/path" className="hover:text-blue-400 transition-colors">JSONPath Query</Link></li>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center text-sm text-slate-400">
          <p>&copy; 2024 JSONUtil.com. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
