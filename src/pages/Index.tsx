...
const Index = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
        ...
        {tools.map((tool, index) => (
          <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardTitle className="text-slate-800 dark:text-slate-200">{tool.title}</CardTitle>
      ...
      {/* Features Section */}
      <div className="bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-slate-200">Privacy First</h3>
            <p className="text-slate-600 dark:text-slate-400">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-slate-200">Always Available</h3>
            <p className="text-slate-600 dark:text-slate-400">
